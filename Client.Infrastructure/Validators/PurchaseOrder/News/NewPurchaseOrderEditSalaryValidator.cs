namespace Client.Infrastructure.Validators.PurchaseOrder.News
{
    public class NewPurchaseOrderEditSalaryValidator : AbstractValidator<NewPurchaseOrderEditSalaryRequest>
    {
        ...
        async Task<bool> ReviewPONumberExist(NewPurchaseOrderEditSalaryRequest Purchaseorder, string ponumber, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewNameExist(NewPurchaseOrderEditSalaryRequest Purchaseorder, string name, CancellationToken cancellationToken)
        {
