...
namespace Client.Infrastructure.Validators.PurchaseOrder.News
{
    public class NewPurchaseOrderApproveValidator : AbstractValidator<NewPurchaseOrderApproveRequest>
    {
        ...
        async Task<bool> ReviewNameExist(NewPurchaseOrderApproveRequest Purchaseorder, string name, CancellationToken cancellationToken)
        {
        ...
        async Task<bool> ReviewPRExist(NewPurchaseOrderApproveRequest Purchaseorder, string pr, CancellationToken cancellationToken)
        {
