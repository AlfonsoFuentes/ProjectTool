...
{
    public class OldPurchaseOrderEditReceiveValidator : AbstractValidator<OldPurchaseOrderEditReceiveRequest>
    {
        private INewPurchaseOrderValidator PurchaseOrderValidator { get; set; }
        public OldPurchaseOrderEditReceiveValidator(INewPurchaseOrderValidator purchaseOrderValidator)
        {
