...
{
    public class NewSupplierCreateBasicRequestValidator : AbstractValidator<NewSupplierCreateBasicRequest>
    {
        private INewSupplierValidatorService _Service;
        public NewSupplierCreateBasicRequestValidator(INewSupplierValidatorService service)
        {
            _Service = service;
