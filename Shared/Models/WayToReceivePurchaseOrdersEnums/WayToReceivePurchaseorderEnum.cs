...
namespace Shared.Models.WayToReceivePurchaseOrdersEnums
{
    public class WayToReceivePurchaseorderEnum
    {
        ...
        public static WayToReceivePurchaseorderEnum GetType(string type) => List.Exists(x => x.Name == type) ? List.FirstOrDefault(x => x.Name == type)! : WayToReceivePurchaseorderEnum.None;
        public static WayToReceivePurchaseorderEnum GetType(int id) => List.Exists(x => x.Id == id) ? List.FirstOrDefault(x => x.Id == id)! : WayToReceivePurchaseorderEnum.None;
    }
}
