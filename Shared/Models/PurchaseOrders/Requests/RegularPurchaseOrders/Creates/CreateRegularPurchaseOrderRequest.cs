...
namespace Shared.Models.PurchaseOrders.Requests.RegularPurchaseOrders.Creates
{
    ...
    public class CreatedRegularPurchaseOrderRequest: PurchaseOrderRequest
    {
        ...
        public override List<PurchaseOrderItemRequest> PurchaseOrderItems { get; set; } = new();
        ...
        public override double SumPOValueCurrency => PurchaseOrderItemNoBlank.Count == 0 ? 0 : Math.Round(PurchaseOrderItemNoBlank.Sum(x => x.TotalCurrencyValue), 2);
