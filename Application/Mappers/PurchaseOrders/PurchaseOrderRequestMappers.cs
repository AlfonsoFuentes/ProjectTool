namespace Application.Mappers.PurchaseOrders
{
    public static class PurchaseOrderRequestMappers
    {
        ...
        public static void ToPurchaseOrderFromSalaryRequest(this NewPurchaseOrderRequest request, PurchaseOrder purchaseOrder)
        {
            purchaseOrder.AccountAssigment = request.AccountAssigment;
            ...
            purchaseOrder.MainBudgetItemId = request.MainBudgetItemId;
            purchaseOrder.PurchaseorderName = request.PurchaseOrderName;
            purchaseOrder.POClosedDate = DateTime.Now;
            purchaseOrder.POExpectedDateDate = DateTime.Now;
            purchaseOrder.PurchaseOrderStatus = PurchaseOrderStatusEnum.Closed.Id;
            purchaseOrder.CurrencyDate = DateTime.Now;
            ...
            purchaseOrder.SPL = "";
            purchaseOrder.PONumber = request.PurchaseOrderNumber;
            purchaseOrder.IsTaxEditable = false;
        }
        ...
        public static NewPurchaseOrderEditSalaryRequest ToPurchaseOrderEditSalaryRequest(this PurchaseOrder purchaseOrder, BudgetItem mainbudgetitem)
        {
            NewPurchaseOrderEditSalaryRequest result = new()
            {
                PurchaseOrder = new()
                {
            ...
            result.PurchaseOrderSalary=result.PurchaseOrder.POActualCurrency;
            result.CreatePurchaseOrderNumber = !string.IsNullOrEmpty(result.PurchaseOrder.PurchaseOrderNumber);
            return result;
        }
