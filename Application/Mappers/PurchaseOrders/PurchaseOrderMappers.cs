...
namespace Application.Mappers.PurchaseOrders
{
    public static class PurchaseOrderMappers
    {
        ...
        public static OldPurchaseOrderReceiveRequest ToPurchaseOrderReceiveRequest(this PurchaseOrder purchaseOrder)
        {
            return new()
            {
                AccountAssigment = purchaseOrder.AccountAssigment,
        ...
        public static OldPurchaseOrderEditReceiveRequest ToPurchaseOrderEditReceiveRequest(this PurchaseOrder purchaseOrder)
        {
            return new()
            {
                AccountAssigment = purchaseOrder.AccountAssigment,
