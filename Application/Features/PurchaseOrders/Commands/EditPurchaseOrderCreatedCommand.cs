...
{
    public record EditPurchaseOrderCreatedCommand(EditPurchaseOrderCreatedRequest Data) : IRequest<IResult>;
    ...
    internal class EditPurchaseOrderCreatedCommandHandler : IRequestHandler<EditPurchaseOrderCreatedCommand, IResult>
    {
        ...
        {
            var validator = new EditPurchaseOrderCreatedValidator(Repository);
