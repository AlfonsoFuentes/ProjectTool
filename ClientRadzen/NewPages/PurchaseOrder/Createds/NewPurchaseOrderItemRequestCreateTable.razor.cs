...
#nullable disable
public partial class NewPurchaseOrderItemRequestCreateTable
{
    [CascadingParameter]
    public App MainApp { get; set; }
    [CascadingParameter]
    public NewPurchaseOrderCreatePage MainPage { get; set; }

    NewPurchaseOrderCreateRequest Model => MainPage.Model;
    int MaxColumn = 12;
