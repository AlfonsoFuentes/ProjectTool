...
#nullable disable
public partial class NewPurchaseOrderItemRequestEditApprovedTable
{
    [CascadingParameter]
    public App MainApp { get; set; }
    [CascadingParameter]
    public NewPurchaseOrderEditApprovedPage MainPage { get; set; }

    NewPurchaseOrderEditApprovedRequest Model => MainPage.Model;
    int MaxColumn = 12;
