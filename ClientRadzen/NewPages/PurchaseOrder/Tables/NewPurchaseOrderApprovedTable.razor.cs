...
#nullable disable
public partial class NewPurchaseOrderApprovedTable
{
    [CascadingParameter]
    ...
    public List<NewPriorPurchaseOrderResponse> PurchaseOrders => MainPage.Approveds;
    ...
    Func<NewPriorPurchaseOrderResponse, bool> fiterexpresion => x =>
          ...
          x.PurchaseOrderNumber.Contains(MainPage.nameFilter, StringComparison.CurrentCultureIgnoreCase) ||
