...
public partial class NewPurchaseOrderEditReceivePage
{
    [CascadingParameter]
    ...
    public NewPurchaseOrderEditReceiveRequest Model = null;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        var resultPurchaseOrder = await Service.GetPurchaseOrderToEditeReceive(PurchaseOrderId);
    ...
    async Task<IResult> SaveAsync()
    {
        ...
        return await Service.EditReceivePurchaseOrderAsync(Model);
    }
