...
#nullable disable
public partial class NewPurchaseOrderEditApprovePage
{
    [CascadingParameter]
    ...
    public NewPurchaseOrderEditApproveRequest Model = null;
    ...
    protected override async Task OnInitializedAsync()
    {
        ...
        var resultPurchaseOrder = await Service.GetPurchaseOrderToEditApproved(PurchaseOrderId);
    ...
    async Task<IResult> SaveAsync()
    {
        ...
        return await Service.EditApprovedPurchaseOrderAsync(Model);
    }
